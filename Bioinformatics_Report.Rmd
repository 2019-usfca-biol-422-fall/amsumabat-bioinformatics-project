...
DADA2 results show that _Proteobacteria_, _Actinobacteria_, and _Firmicutes_ were the top three phyla that dominated in abundance across my samples (Figure 8). _Acinetobacter_, _Acidovorax_, and _Pseudomonas_ were the top three most abundant genus found within the environmental samples (Figure 11).
