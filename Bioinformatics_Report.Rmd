...
DADA2 [@callahan2016dada2] and phyloseq [@mcmurdie2012phyloseq] were also used to analyze the environmental samples. DADA2 was used to filter, trim, build error models, get rid of duplicated samples, denoise sequences, check for and remove chimeras, and assign taxonomy to the sequences. DADA2 was also used to create a phyloseq object that was melted and and plotted to visualize results. 
