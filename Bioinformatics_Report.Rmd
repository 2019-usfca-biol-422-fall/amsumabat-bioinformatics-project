...
The results from the Illumina sequencer were not what I expected. I found thousands of sequences from different organisms within each sample, including the positive and negative controls. The sequences found in the controls could possibly be due to contamination that must have taken place sometime during the preparation for the sequencer. Out of the thousands of sequences from my environmental samples, none of them matched with the organisms I obtained from BLASTing the culture samples.
