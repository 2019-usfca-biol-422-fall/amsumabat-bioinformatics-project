...
# more info here: install.packages("citr")
# and here:
...
filter_path <- file.path("/home", "Sumabat_Adelle", "filtered")
...
# Extract sample names, assuming files have format: SAMPLENAME.fastq
